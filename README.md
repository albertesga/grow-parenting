...
- **`design/Mimo Design System v0.2.html`** · DS canónico · single source of truth
...
│   └── package.json
├── design/
│   ├── Mimo Design System v0.2.html           # DS canónico (~7k líneas)
...
- **Ink hierarchy** · `#34342D` (ink) / `#4D4D4D` (ink-soft) / `#888888` (ink-muted) / `#BFBAA8` (ink-faint)
...
Detalle completo · `.agent/rules/typography.md` + `.agent/rules/palette-tonal.md` + `design/Mimo Design System v0.2.html` § Foundations.
