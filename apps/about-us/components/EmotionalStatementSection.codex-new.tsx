...
function DesktopLayout(p: DesktopProps) {
  return (
    <div className="grid h-full w-full grid-cols-[minmax(300px,0.9fr)_minmax(280px,0.72fr)_minmax(330px,0.82fr)] items-center gap-[clamp(28px,3.4vw,88px)] px-[clamp(44px,5vw,128px)] xl:grid-cols-[minmax(340px,0.88fr)_minmax(310px,0.7fr)_minmax(360px,0.78fr)] 2xl:px-[clamp(72px,6vw,168px)]">
      ...
      <div className="relative z-20 aspect-[4/5] w-[min(24vw,380px)] min-w-[280px] justify-self-center">
      ...
      <div className="relative z-30 min-w-0 max-w-[520px] justify-self-end text-ink">
        ...
        <motion.p
          className="mt-4 max-w-[26ch] font-text text-[clamp(17px,1.16vw,25px)] font-light leading-[1.5] text-ink-soft"
        ...
        >
          ...
          <span className="font-bold text-ink">hij@s</span>.
        </motion.p>
...
function MobileLayout(p: MobileProps) {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-4 px-5 pt-20 pb-6 sm:gap-5 sm:px-8 md:gap-6">
      ...
      <div className="w-full max-w-[480px] text-ink">
        ...
        <div className="font-serif">
          <motion.div
            className="text-[clamp(34px,9.2vw,54px)] font-light leading-[0.98] tracking-tight"
            style={{ opacity: p.line1Opacity, y: p.line1Y, letterSpacing: '-0.018em' }}
          >
            Probablemente
          </motion.div>
          ...
          <motion.div
            className="text-[clamp(34px,9.2vw,54px)] font-bold leading-[0.98] tracking-tight"
            style={{ opacity: p.line3Opacity, y: p.line3Y, letterSpacing: '-0.018em' }}
          >
            del mundo.
          </motion.div>
      ...
      <div className="relative w-[min(58vw,260px)] max-w-[260px]" style={{ aspectRatio: '4 / 5' }}>
      ...
      <div className="w-full max-w-[420px] text-ink">
        ...
        <motion.h2
          className="font-serif text-[clamp(25px,6vw,34px)] font-bold leading-[1.02] tracking-tight"
        ...
        <motion.div
          className="mt-4 font-text text-[clamp(15px,4vw,18px)] font-light leading-[1.35]"
          style={{ opacity: p.r2Opacity, y: p.r2Y, letterSpacing: '-0.005em' }}
        >
          <span className="font-bold">Padre</span> de{' '}
          <span className="font-bold">Inti</span> y{' '}
        ...
        <motion.p
          className="mt-1.5 font-text text-[clamp(14px,3.8vw,18px)] font-light leading-[1.4] text-ink-soft"
          style={{ opacity: p.r4Opacity, y: p.r4Y, letterSpacing: '-0.005em' }}
        >
          Aunque <span className="font-bold text-ink">nadie</span> me enseñó a{' '}
          <span className="font-bold text-ink">ser padre</span>.
